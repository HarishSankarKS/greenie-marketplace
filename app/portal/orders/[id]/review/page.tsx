      ...
      <div style={{ background: "var(--color-neutral-100)", minHeight: "100vh", display: "flex", flexDirection: "column" }}>
        <div style={{ background: "var(--color-primary-900)", borderBottom: "3px solid var(--color-accent-amber)", padding: "28px 0" }}>
          <div className="container-page">
            <h1 style={{ fontSize: 20, fontWeight: 800, color: "#fff" }}>Review Submitted</h1>
          </div>
        </div>
        <div style={{ flex: 1, display: "flex", alignItems: "center", justifyContent: "center", padding: 40 }}>
          <div style={{ textAlign: "center", maxWidth: 360 }}>
            ...
            <p style={{ fontSize: 14, color: "var(--color-neutral-500)", lineHeight: 1.7, marginBottom: 28 }}>
              Your review has been posted and helps other buyers make better purchasing decisions.
            </p>
            <Link href="/portal/orders" className="btn-primary" style={{ display: "inline-flex" }}>
              Back to My Orders
            </Link>
          </div>
        </div>
    ...
    <div style={{ background: "var(--color-neutral-100)", minHeight: "100vh" }}>
      ...
      <div className="container-page" style={{ maxWidth: 640, paddingTop: 28, paddingBottom: 64 }}>
        <div style={{
            ...
            {ratingCategories.map(({ key, label, emoji, desc }) => (
              <div key={key} style={{ paddingBottom: 24, borderBottom: "1px solid var(--color-neutral-100)" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 12 }}>
                  <div>
                    <p style={{ fontSize: 15, fontWeight: 700, color: "var(--color-neutral-900)", display: "flex", alignItems: "center", gap: 8 }}>
                    ...
                    return (
                      <button
                        ...
                        <Star style={{
                          ...
                          color: filled ? "#F59E0B" : "var(--color-neutral-200)",
          ...
          <div style={{ marginBottom: 28 }}>
            ...
            <textarea
              ...
              style={{
                ...
                color: "var(--color-neutral-900)", resize: "none",
                background: "var(--color-neutral-100)", lineHeight: 1.6,
                fontFamily: "inherit"
              }}
            />
          </div>
          ...
          {!allRated && (
            <p style={{ textAlign: "center", fontSize: 12, color: "var(--color-neutral-500)", marginTop: 10 }}>
